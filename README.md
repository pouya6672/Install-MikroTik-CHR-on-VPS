...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/pouya6672/Install-MikroTik-CHR-on-VPS/main/mik-6486.sh)"
```

For MikroTik 7.20.2

```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/pouya6672/Install-MikroTik-CHR-on-VPS/main/mik78.sh)"
```
